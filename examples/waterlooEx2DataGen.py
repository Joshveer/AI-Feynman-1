...
g = np.random.uniform(9.81, 10, n)              # Acceleration due to gravity (constant, approximately 9.81 m/s^2)
rho = np.random.uniform(1.0, 1.5, n) # Fluid density between 1.0 and 1.5 kg/m³
Cd = np.random.uniform(0.1, 1, n)  # Drag coefficient between 0.1 and 1.0
